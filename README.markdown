...
This directory contains source files for the Klingon language morphology
and dictionary. The data and implementation are licenced under GNU GPLv3
licence also detailed in the LICENCE file of this directory. The authors
...
This analyser was just used for testing purposes.

Documentation can be found here:

-   <https://giellalt.uit.no/lang/tlh/index.html> (analyser)
...
The Klingon language sources can be acquired using [giella SVN
